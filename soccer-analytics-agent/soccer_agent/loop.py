...
SYSTEM_PROMPT = (
    ...
    "The stage column is populated only for the 2026 FIFA World Cup. "
    "Canonical stage values for 2026 include Final, Semi-finals, "
    "Third-place playoff, Quarter-finals, Round of 16, Round of 32, and "
    "Group stage. For any other tournament or year, do not filter by stage — "
    "use ORDER BY match_date DESC instead. "
    ...
    "Podium: only for the 2026 World Cup, when stage is set, filter by stage — "
    "third place is the Third-place playoff row (rival = home vs away on that "
    "row); use AND stage = 'Final' or AND stage = 'Semi-finals' similarly. "
    "For other tournaments (or when stage is NULL), use ORDER BY match_date "
    "DESC LIMIT 2 with no OFFSET "
